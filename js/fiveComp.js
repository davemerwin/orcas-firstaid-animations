var context = {
	...
	c6Svg: "mod5/5c6.xml",
	c6_1Mp3: "mod5/Audio/5c6-1.mp3",
	c6_1Ogg: "mod5/Audio/5c6-1.ogg",
	c6_1TimeUpdates: [{t:2, done:false, action:function(){
		HandGlow(map['FingersGlow'], map['FingersTarget']);
	}}, {t: 6.5, done:false, action:function(){
		DepthGlow(map['OneThird']);}}],
	c6_2Mp3: "mod5/Audio/5c6-2.mp3",
	c6_2Ogg: "mod5/Audio/5c6-2.ogg",
	...
	c7Mp3: "mod5/Audio/5c7.mp3",
	c7Ogg: "mod5/Audio/5c7.ogg",
	c7TimeUpdates: [{t:5.5, done: false, action: function(){
	...
	c8Mp3: "mod5/Audio/5c8.mp3",
	c8Ogg: "mod5/Audio/5c8.ogg",
	beep:  "mod3/Audio/beep.mp3",
	beepOgg:  "mod3/Audio/beepOgg.mp3",
	...
	}}, {t: 13.5, done: false, action: function(){
		AnimateOpacityDown(map['DiagramGlow'], 2500);
	}}],
	c8Drag: {move: null, start: null, up: null},
	c8Instructions: {x:480, y:75, text:"Click and hold\nwhile dragging\nup and down to\ngive compressions."},
	...
	c8SuccessMp3: "mod5/Audio/5c8Success.mp3",
	c8SuccessOgg: "mod5/Audio/5c8Success.ogg",
	...
	c8FailAudio: function(problem){
		return "mod5/Audio/5c8Fail" + problem + ".mp3";
	},
};